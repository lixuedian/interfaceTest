...
if __name__ == '__main__':#通过写死参数，来验证我们写的请求是否正确
    ...
    result = RunMain().run_main('post', 'http://order100.ekeguan.com/v1/account/login', 'projectId=2&source=103&mobilestyle=android_V2.9.0_HUAWEI_EML-AL00_Android_29&areaCode=86&mobileno=d8995874706055d0335afd633d05b182&password=123456')
    print(result)